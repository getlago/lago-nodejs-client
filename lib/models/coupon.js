...
export default class Coupon {
    ...
    wrapAttributes = function () {
      ...
      let limitationConfiguration = this.wrapLimitationAttributes();
      if (limitationConfiguration != undefined) result.coupon.applies_to = limitationConfiguration;

        return result;
    }

  wrapLimitationAttributes = function() {
    if (!this.attributes.appliesTo) { return };

    return this.attributes.appliesTo.wrapAttributes();
  }
}
