...
export default class Client {
    ...
    async updateCoupon(input, identifier){
        let payload = {}
        if (input.hasOwnProperty('name')) payload.name = input.name;
        if (input.hasOwnProperty('code')) payload.code = input.code;
        if (input.hasOwnProperty('expiration')) payload.expiration = input.expiration;
        if (input.hasOwnProperty('amountCents')) payload.amount_cents = input.amountCents;
        if (input.hasOwnProperty('amountCurrency')) payload.amount_currency = input.amountCurrency;
        if (input.hasOwnProperty('expirationDuration')) payload.expiration_duration = input.expirationDuration;
        ...
        let response;
        await this.apiRequest(`/coupons/${identifier}`, 'put', body)
            .then(res => response = res.coupon);
    ...
    async updateAddOn(input, identifier){
        let payload = {}
        if (input.hasOwnProperty('name')) payload.name = input.name;
        if (input.hasOwnProperty('code')) payload.code = input.code;
        if (input.hasOwnProperty('description')) payload.description = input.description;
        ...
        let response;
        await this.apiRequest(`/add_ons/${identifier}`, 'put', body)
            .then(res => response = res.add_on);
    ...
    async updateOrganization(input){
        let payload = {}
        if (input.hasOwnProperty('webhookUrl')) payload.webhook_url = input.webhookUrl;
        if (input.hasOwnProperty('vatRate')) payload.vat_rate = input.vatRate;
        if (input.hasOwnProperty('country')) payload.country = input.country;
        if (input.hasOwnProperty('addressLine1')) payload.address_line1 = input.addressLine1;
        if (input.hasOwnProperty('addressLine2')) payload.address_line2 = input.addressLine2;
        if (input.hasOwnProperty('state')) payload.state = input.state;
        if (input.hasOwnProperty('zipcode')) payload.zipcode = input.zipcode;
        if (input.hasOwnProperty('email')) payload.email = input.email;
        if (input.hasOwnProperty('city')) payload.city = input.city;
        if (input.hasOwnProperty('legalName')) payload.legal_name = input.legalName;
        if (input.hasOwnProperty('legalNumber')) payload.legal_number = input.legalNumber;
        if (input.hasOwnProperty('invoiceFooter')) payload.invoice_footer = input.invoiceFooter;
        ...
        let response;
        await this.apiRequest(`/organizations`, 'put', body)
