...
export default class Client {
    ...
    async destroyAppliedCoupon(externalCustomerId, appliedCouponId) {
        let response;
        await this.apiRequest(`/customers/${externalCustomerId}/applied_coupons/${appliedCouponId}`, 'delete')
            .then(res => response = res.applied_coupon);
    ...
    async updateInvoice(inputInvoice, identifier){
        let response;
        await this.apiRequest(`/invoices/${identifier}`, 'put', inputInvoice.wrapAttributes())
            .then(res => response = res.invoice);
